...
import {
    ...
    CSS_PINK, CSS_BROWN,
    SRGBColorSpace, LinearSRGBColorSpace, DisplayP3ColorSpace,
    Rec2020ColorSpace, ACESColorSpace, HSLColorSpace, HSVColorSpace,
    CMYKColorSpace, LABColorSpace, XYZColorSpace, OKLABColorSpace, OKLCHColorSpace,
    EPSILON
...
export const ColorSpace = {
    ...
    DISPLAY_P3: DisplayP3ColorSpace,
    ...
    blendDarken: (c1, c2, t) => blendColors(c1, c2, t, 'darken'),
    blendLighten: (c1, c2, t) => blendColors(c1, c2, t, 'lighten'),
    blendColorDodge: (c1, c2, t) => blendColors(c1, c2, t, 'color-dodge'),
    blendColorBurn: (c1, c2, t) => blendColors(c1, c2, t, 'color-burn'),
    blendHardLight: (c1, c2, t) => blendColors(c1, c2, t, 'hard-light'),
    blendSoftLight: (c1, c2, t) => blendColors(c1, c2, t, 'soft-light'),
    blendDifference: (c1, c2, t) => blendColors(c1, c2, t, 'difference'),
    blendExclusion: (c1, c2, t) => blendColors(c1, c2, t, 'exclusion'),
    ...
    srgbToLinear(c) {
        if (typeof c !== 'number') {
            throw new TypeError('LXRN.ColorSpace.srgbToLinear: c must be a number');
        }
        if (c < 0) return 0;
        if (c > 1) return 1;
    ...
    linearToSrgb(c) {
        if (typeof c !== 'number') {
            throw new TypeError('LXRN.ColorSpace.linearToSrgb: c must be a number');
        }
        if (c < 0) return 0;
        if (c > 1) return 1;
    ...
    rgbToLinear(r, g, b) {
        ...
        if (typeof r !== 'number' || typeof g !== 'number' || typeof b !== 'number') {
            throw new TypeError('LXRN.ColorSpace.rgbToLinear: r, g, and b must be numbers or an object');
        }
        return {
    ...
    linearToRgb(r, g, b) {
        ...
        if (typeof r !== 'number' || typeof g !== 'number' || typeof b !== 'number') {
            throw new TypeError('LXRN.ColorSpace.linearToRgb: r, g, and b must be numbers or an object');
        }
        return {
    ...
    rgbToXyz(r, g, b) {
        ...
        if (typeof r !== 'number' || typeof g !== 'number' || typeof b !== 'number') {
            throw new TypeError('LXRN.ColorSpace.rgbToXyz: r, g, and b must be numbers or an object');
        }
        return {
    ...
    xyzToRgb(x, y, z) {
        if (typeof x !== 'number' || typeof y !== 'number' || typeof z !== 'number') {
            throw new TypeError('LXRN.ColorSpace.xyzToRgb: x, y, and z must be numbers');
        }
        return {
    ...
    xyzToLab(x, y, z) {
        if (typeof x !== 'number' || typeof y !== 'number' || typeof z !== 'number') {
            throw new TypeError('LXRN.ColorSpace.xyzToLab: x, y, and z must be numbers');
        }
    ...
    labToXyz(l, a, b) {
        if (typeof l !== 'number' || typeof a !== 'number' || typeof b !== 'number') {
            throw new TypeError('LXRN.ColorSpace.labToXyz: l, a, and b must be numbers');
        }
        const fy = (l + 16) / 116;
        const fx = fy + a / 500;
        const fz = fy - b / 200;
    ...
    temperatureToRgb(temp) {
        if (typeof temp !== 'number' || temp < 0) {
            throw new TypeError('LXRN.ColorSpace.temperatureToRgb: temp must be a non-negative number');
        }
        let t = temp / 100;
        let r, g, b;
    ...
    reinhardToneMapping(color, exposure = 1) {
        if (typeof color !== 'object' || color.r === undefined) {
            throw new TypeError('LXRN.ColorSpace.reinhardToneMapping: color must be a color object');
        }
        if (typeof exposure !== 'number' || exposure <= 0) {
            throw new Error('LXRN.ColorSpace.reinhardToneMapping: exposure must be a positive number');
        }
    ...
    acesFilmicToneMapping(color, exposure = 1) {
        if (typeof color !== 'object' || color.r === undefined) {
            throw new TypeError('LXRN.ColorSpace.acesFilmicToneMapping: color must be a color object');
        }
        if (typeof exposure !== 'number' || exposure <= 0) {
            throw new Error('LXRN.ColorSpace.acesFilmicToneMapping: exposure must be a positive number');
        }
        const r = color.r * exposure, g = color.g * exposure, b = color.b * exposure;
    ...
    gammaCorrect(color, gamma = 2.2) {
        if (typeof color !== 'object' || color.r === undefined) {
            throw new TypeError('LXRN.ColorSpace.gammaCorrect: color must be a color object');
        }
        if (typeof gamma !== 'number' || gamma <= 0) {
            throw new Error('LXRN.ColorSpace.gammaCorrect: gamma must be a positive number');
        }
        return {
    ...
    gammaDecode(color, gamma = 2.2) {
        if (typeof color !== 'object' || color.r === undefined) {
            throw new TypeError('LXRN.ColorSpace.gammaDecode: color must be a color object');
        }
        if (typeof gamma !== 'number' || gamma <= 0) {
            throw new Error('LXRN.ColorSpace.gammaDecode: gamma must be a positive number');
        }
        return {
