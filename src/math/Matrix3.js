...
export class Matrix3 {
    ...
    // ===== STATIC =====
    static get isMatrix3() { return true; }
    ...
    // ===== DEPRECATED (untuk kompatibilitas) =====
    scale(sx, sy) {
        console.warn('Matrix3: .scale() is deprecated. Use .makeScale() instead.');
        this.premultiply(_m3.makeScale(sx, sy));
        return this;
    }

    rotate(theta) {
        console.warn('Matrix3: .rotate() is deprecated. Use .makeRotation() instead.');
        this.premultiply(_m3.makeRotation(-theta));
        return this;
    }

    translate(tx, ty) {
        console.warn('Matrix3: .translate() is deprecated. Use .makeTranslation() instead.');
